...
static const Formats formatsMap[PF_RGBA_DXT5+1] = {
    { PF_RED_8, DATA_UNSIGNED_BYTE, TF_RED, TIF_R8, 8, 8 },
    { PF_RED_U8, DATA_UNSIGNED_BYTE, TF_RED_INTEGER, TIF_R8UI, 8, 8 },
    { PF_RED_I8, DATA_BYTE, TF_RED_INTEGER, TIF_R8I, 8, 8 },
    { PF_RED_SN8, DATA_BYTE, TF_RED, TIF_R8_SNORM, 8, 8 },

    { PF_RED_16, DATA_UNSIGNED_SHORT, TF_RED, TIF_R16, 16, 16 },
    { PF_RED_U16, DATA_UNSIGNED_SHORT, TF_RED_INTEGER, TIF_R16UI, 16, 16 },
    { PF_RED_I16, DATA_SHORT, TF_RED_INTEGER, TIF_R16I, 16, 16 },
    { PF_RED_SN16, DATA_SHORT, TF_RED, TIF_R16_SNORM, 16, 16 },

    { PF_RED_U32, DATA_UNSIGNED_INT, TF_RED_INTEGER, TIF_R32UI, 32, 32 },
    { PF_RED_I32, DATA_INT, TF_RED_INTEGER, TIF_R32I, 32, 32 },

    { PF_RED_F16, DATA_HALF_FLOAT, TF_RED, TIF_R16F, 16, 16 },
    { PF_RED_F32, DATA_FLOAT, TF_RED, TIF_R32F, 32, 32 },

    { PF_RG_8, DATA_UNSIGNED_BYTE, TF_RG, TIF_RG8, 2*8, 2*8 },
    { PF_RG_U8, DATA_UNSIGNED_BYTE, TF_RG_INTEGER, TIF_RG8UI, 2*8, 2*8 },
    { PF_RG_I8, DATA_BYTE, TF_RG_INTEGER, TIF_RG8I, 2*8, 2*8 },
    { PF_RG_SN8, DATA_BYTE, TF_RG, TIF_RG8_SNORM, 2*8, 2*8 },

    { PF_RG_16, DATA_UNSIGNED_SHORT, TF_RG, TIF_RG16, 2*16, 2*16 },
    { PF_RG_U16, DATA_UNSIGNED_SHORT, TF_RG_INTEGER, TIF_RG16UI, 2*16, 2*16 },
    { PF_RG_I16, DATA_SHORT, TF_RG_INTEGER, TIF_RG16I, 2*16, 2*16 },
    { PF_RG_SN16, DATA_SHORT, TF_RG, TIF_RG16_SNORM, 2*16, 2*16 },

    { PF_RG_U32, DATA_UNSIGNED_INT, TF_RG_INTEGER, TIF_RG32UI, 2*32, 2*32 },
    { PF_RG_I32, DATA_INT, TF_RG_INTEGER, TIF_RG32I, 2*32, 2*32 },

    { PF_RG_F16, DATA_HALF_FLOAT, TF_RG, TIF_RG16F, 2*16, 2*16 },
    { PF_RG_F32, DATA_FLOAT, TF_RG, TIF_RG32F, 2*32, 2*32 },

    { PF_RGB_8, DATA_UNSIGNED_BYTE, TF_RGB, TIF_RGB8, 3*8, 3*8 },
    { PF_RGB_U8, DATA_UNSIGNED_BYTE, TF_RGB_INTEGER, TIF_RGB8UI, 3*8, 3*8 },
    { PF_RGB_I8, DATA_BYTE, TF_RGB_INTEGER, TIF_RGB8I, 3*8, 3*8 },
    { PF_RGB_SN8, DATA_BYTE, TF_RGB, TIF_RGB8_SNORM, 3*8, 3*8 },

    { PF_RGB_U16, DATA_UNSIGNED_SHORT, TF_RGB_INTEGER, TIF_RGB16UI, 3*16, 3*16 },
    { PF_RGB_I16, DATA_SHORT, TF_RGB_INTEGER, TIF_RGB16I, 3*16, 3*16 },
    { PF_RGB_SN16, DATA_SHORT, TF_RGB, TIF_RGB16_SNORM, 3*16, 3*16 },

    { PF_RGB_U32, DATA_UNSIGNED_INT, TF_RGB_INTEGER, TIF_RGB32UI, 3*32, 3*32 },
    { PF_RGB_I32, DATA_INT, TF_RGB_INTEGER, TIF_RGB32I, 3*32, 3*32 },

    { PF_RGB_F16, DATA_HALF_FLOAT, TF_RGB, TIF_RGB16F, 3*16, 3*16 },
    { PF_RGB_F32, DATA_FLOAT, TF_RGB, TIF_RGB32F, 3*32, 3*32 },

    { PF_RGBA_8, DATA_UNSIGNED_BYTE, TF_RGBA, TIF_RGBA8, 4*8, 4*8 },
    { PF_RGBA_U8,  DATA_UNSIGNED_BYTE, TF_RGBA_INTEGER, TIF_RGBA8UI, 4*8, 4*8 },
    { PF_RGBA_I8,  DATA_BYTE, TF_RGBA_INTEGER, TIF_RGBA8I, 4*8, 4*8 },
    { PF_RGBA_SN8,  DATA_BYTE, TF_RGBA, TIF_RGBA8_SNORM, 4*8, 4*8 },

    { PF_RGBA_16,  DATA_UNSIGNED_SHORT, TF_RGBA, TIF_RGBA16, 4*16, 4*16 },
    { PF_RGBA_U16,  DATA_UNSIGNED_SHORT, TF_RGBA_INTEGER, TIF_RGBA16UI, 4*16, 4*16 },
    { PF_RGBA_I16,  DATA_SHORT, TF_RGBA_INTEGER, TIF_RGBA16I, 4*16, 4*16 },
    { PF_RGBA_SN16,  DATA_SHORT, TF_RGBA, TIF_RGBA16_SNORM, 4*16, 4*16 },

    { PF_RGBA_U32,  DATA_UNSIGNED_INT, TF_RGBA_INTEGER, TIF_RGBA32UI, 4*32, 4*32 },
    { PF_RGBA_I32,  DATA_INT, TF_RGBA_INTEGER, TIF_RGBA32I, 4*32, 4*32 },
    ...
    { PF_RGBA_DXT1, DATA_UNSIGNED_BYTE, TF_COMPRESSED_RGBA_S3TC_DXT1, TIF_COMPRESSED_RGBA_S3TC_DXT1,  4, 4 },
