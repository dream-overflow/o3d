...
enum TextureIntFormat
{
	TIF_R8                        = 0x8229,
	TIF_RG8                       = 0x822B,
	TIF_LUMINANCE8                = 0x8040,  //!< OGL <3 compliance for TIF_R8
	TIF_LUMINANCE8_ALPHA8         = 0x8045,  //!< OGL <3 compliance for TIF_RG8
	TIF_RGB8                      = 0x8051,
	TIF_RGBA8                     = 0x8058,
	TIF_R16F                      = 0x822D,
	TIF_R32F                      = 0x822E,
	...
	TIF_RGBA32F                   = 0x8814,
	TIF_RGB32F                    = 0x8815,
	TIF_LUMINANCE32F              = 0x8818,  //!< OGL <3 compliance for TIF_R32F
	TIF_LUMINANCE_ALPHA32F        = 0x8819,  //!< OGL <3 compliance for TIF_RG32F
	TIF_RGBA16F                   = 0x881A,
	TIF_RGB16F                    = 0x881B,
	TIF_LUMINANCE16F              = 0x881E,  //!< OGL <3 compliance for TIF_R16F
	TIF_LUMINANCE_ALPHA16F        = 0x881F,  //!< OGL <3 compliance for TIF_RG16F
