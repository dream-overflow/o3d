...
public:
     ...
     * Depending of the build options and dynamic target.
     */
    static void init();
...
O3D_GLAPI PFNGLRELEASESHADERCOMPILERPROC glReleaseShaderCompiler;
O3D_GLAPI PFNGLSHADERBINARYPROC glShaderBinary;
O3D_GLAPI PFNGLGETSHADERPRECISIONFORMATPROC glGetShaderPrecisionFormat;
O3D_GLAPI PFNGLDEPTHRANGEFPROC glDepthRangef;
O3D_GLAPI PFNGLCLEARDEPTHFPROC glClearDepthf;
O3D_GLAPI PFNGLGETPROGRAMBINARYPROC glGetProgramBinary;
O3D_GLAPI PFNGLPROGRAMBINARYPROC glProgramBinary;
O3D_GLAPI PFNGLPROGRAMPARAMETERIPROC glProgramParameteri;
O3D_GLAPI PFNGLUSEPROGRAMSTAGESPROC glUseProgramStages;
O3D_GLAPI PFNGLACTIVESHADERPROGRAMPROC glActiveShaderProgram;
O3D_GLAPI PFNGLCREATESHADERPROGRAMVPROC glCreateShaderProgramv;
O3D_GLAPI PFNGLBINDPROGRAMPIPELINEPROC glBindProgramPipeline;
O3D_GLAPI PFNGLDELETEPROGRAMPIPELINESPROC glDeleteProgramPipelines;
O3D_GLAPI PFNGLGENPROGRAMPIPELINESPROC glGenProgramPipelines;
O3D_GLAPI PFNGLISPROGRAMPIPELINEPROC glIsProgramPipeline;
O3D_GLAPI PFNGLGETPROGRAMPIPELINEIVPROC glGetProgramPipelineiv;
O3D_GLAPI PFNGLPROGRAMUNIFORM1IPROC glProgramUniform1i;
O3D_GLAPI PFNGLPROGRAMUNIFORM1IVPROC glProgramUniform1iv;
O3D_GLAPI PFNGLPROGRAMUNIFORM1FPROC glProgramUniform1f;
O3D_GLAPI PFNGLPROGRAMUNIFORM1FVPROC glProgramUniform1fv;
O3D_GLAPI PFNGLPROGRAMUNIFORM1DPROC glProgramUniform1d;
O3D_GLAPI PFNGLPROGRAMUNIFORM1DVPROC glProgramUniform1dv;
O3D_GLAPI PFNGLPROGRAMUNIFORM1UIPROC glProgramUniform1ui;
O3D_GLAPI PFNGLPROGRAMUNIFORM1UIVPROC glProgramUniform1uiv;
O3D_GLAPI PFNGLPROGRAMUNIFORM2IPROC glProgramUniform2i;
O3D_GLAPI PFNGLPROGRAMUNIFORM2IVPROC glProgramUniform2iv;
O3D_GLAPI PFNGLPROGRAMUNIFORM2FPROC glProgramUniform2f;
O3D_GLAPI PFNGLPROGRAMUNIFORM2FVPROC glProgramUniform2fv;
O3D_GLAPI PFNGLPROGRAMUNIFORM2DPROC glProgramUniform2d;
O3D_GLAPI PFNGLPROGRAMUNIFORM2DVPROC glProgramUniform2dv;
O3D_GLAPI PFNGLPROGRAMUNIFORM2UIPROC glProgramUniform2ui;
O3D_GLAPI PFNGLPROGRAMUNIFORM2UIVPROC glProgramUniform2uiv;
O3D_GLAPI PFNGLPROGRAMUNIFORM3IPROC glProgramUniform3i;
O3D_GLAPI PFNGLPROGRAMUNIFORM3IVPROC glProgramUniform3iv;
O3D_GLAPI PFNGLPROGRAMUNIFORM3FPROC glProgramUniform3f;
O3D_GLAPI PFNGLPROGRAMUNIFORM3FVPROC glProgramUniform3fv;
O3D_GLAPI PFNGLPROGRAMUNIFORM3DPROC glProgramUniform3d;
O3D_GLAPI PFNGLPROGRAMUNIFORM3DVPROC glProgramUniform3dv;
O3D_GLAPI PFNGLPROGRAMUNIFORM3UIPROC glProgramUniform3ui;
O3D_GLAPI PFNGLPROGRAMUNIFORM3UIVPROC glProgramUniform3uiv;
O3D_GLAPI PFNGLPROGRAMUNIFORM4IPROC glProgramUniform4i;
O3D_GLAPI PFNGLPROGRAMUNIFORM4IVPROC glProgramUniform4iv;
O3D_GLAPI PFNGLPROGRAMUNIFORM4FPROC glProgramUniform4f;
O3D_GLAPI PFNGLPROGRAMUNIFORM4FVPROC glProgramUniform4fv;
O3D_GLAPI PFNGLPROGRAMUNIFORM4DPROC glProgramUniform4d;
O3D_GLAPI PFNGLPROGRAMUNIFORM4DVPROC glProgramUniform4dv;
O3D_GLAPI PFNGLPROGRAMUNIFORM4UIPROC glProgramUniform4ui;
O3D_GLAPI PFNGLPROGRAMUNIFORM4UIVPROC glProgramUniform4uiv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX2FVPROC glProgramUniformMatrix2fv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX3FVPROC glProgramUniformMatrix3fv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX4FVPROC glProgramUniformMatrix4fv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX2DVPROC glProgramUniformMatrix2dv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX3DVPROC glProgramUniformMatrix3dv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX4DVPROC glProgramUniformMatrix4dv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX2X3FVPROC glProgramUniformMatrix2x3fv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX3X2FVPROC glProgramUniformMatrix3x2fv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX2X4FVPROC glProgramUniformMatrix2x4fv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX4X2FVPROC glProgramUniformMatrix4x2fv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX3X4FVPROC glProgramUniformMatrix3x4fv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX4X3FVPROC glProgramUniformMatrix4x3fv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX2X3DVPROC glProgramUniformMatrix2x3dv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX3X2DVPROC glProgramUniformMatrix3x2dv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX2X4DVPROC glProgramUniformMatrix2x4dv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX4X2DVPROC glProgramUniformMatrix4x2dv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX3X4DVPROC glProgramUniformMatrix3x4dv;
O3D_GLAPI PFNGLPROGRAMUNIFORMMATRIX4X3DVPROC glProgramUniformMatrix4x3dv;
O3D_GLAPI PFNGLVALIDATEPROGRAMPIPELINEPROC glValidateProgramPipeline;
O3D_GLAPI PFNGLGETPROGRAMPIPELINEINFOLOGPROC glGetProgramPipelineInfoLog;
O3D_GLAPI PFNGLVERTEXATTRIBL1DPROC glVertexAttribL1d;
O3D_GLAPI PFNGLVERTEXATTRIBL2DPROC glVertexAttribL2d;
O3D_GLAPI PFNGLVERTEXATTRIBL3DPROC glVertexAttribL3d;
O3D_GLAPI PFNGLVERTEXATTRIBL4DPROC glVertexAttribL4d;
O3D_GLAPI PFNGLVERTEXATTRIBL1DVPROC glVertexAttribL1dv;
O3D_GLAPI PFNGLVERTEXATTRIBL2DVPROC glVertexAttribL2dv;
O3D_GLAPI PFNGLVERTEXATTRIBL3DVPROC glVertexAttribL3dv;
O3D_GLAPI PFNGLVERTEXATTRIBL4DVPROC glVertexAttribL4dv;
O3D_GLAPI PFNGLVERTEXATTRIBLPOINTERPROC glVertexAttribLPointer;
O3D_GLAPI PFNGLGETVERTEXATTRIBLDVPROC glGetVertexAttribLdv;
O3D_GLAPI PFNGLVIEWPORTARRAYVPROC glViewportArrayv;
O3D_GLAPI PFNGLVIEWPORTINDEXEDFPROC glViewportIndexedf;
O3D_GLAPI PFNGLVIEWPORTINDEXEDFVPROC glViewportIndexedfv;
O3D_GLAPI PFNGLSCISSORARRAYVPROC glScissorArrayv;
O3D_GLAPI PFNGLSCISSORINDEXEDPROC glScissorIndexed;
O3D_GLAPI PFNGLSCISSORINDEXEDVPROC glScissorIndexedv;
O3D_GLAPI PFNGLDEPTHRANGEARRAYVPROC glDepthRangeArrayv;
O3D_GLAPI PFNGLDEPTHRANGEINDEXEDPROC glDepthRangeIndexed;
O3D_GLAPI PFNGLGETFLOATI_VPROC glGetFloati_v;
O3D_GLAPI PFNGLGETDOUBLEI_VPROC glGetDoublei_v;
...
O3D_GLAPI PFNGLCLIPCONTROLPROC glClipControl;
O3D_GLAPI PFNGLCREATETRANSFORMFEEDBACKSPROC glCreateTransformFeedbacks;
O3D_GLAPI PFNGLTRANSFORMFEEDBACKBUFFERBASEPROC glTransformFeedbackBufferBase;
O3D_GLAPI PFNGLTRANSFORMFEEDBACKBUFFERRANGEPROC glTransformFeedbackBufferRange;
O3D_GLAPI PFNGLGETTRANSFORMFEEDBACKIVPROC glGetTransformFeedbackiv;
O3D_GLAPI PFNGLGETTRANSFORMFEEDBACKI_VPROC glGetTransformFeedbacki_v;
O3D_GLAPI PFNGLGETTRANSFORMFEEDBACKI64_VPROC glGetTransformFeedbacki64_v;
...
O3D_GLAPI PFNGLCREATERENDERBUFFERSPROC glCreateRenderbuffers;
O3D_GLAPI PFNGLNAMEDRENDERBUFFERSTORAGEPROC glNamedRenderbufferStorage;
O3D_GLAPI PFNGLNAMEDRENDERBUFFERSTORAGEMULTISAMPLEPROC glNamedRenderbufferStorageMultisample;
O3D_GLAPI PFNGLGETNAMEDRENDERBUFFERPARAMETERIVPROC glGetNamedRenderbufferParameteriv;
O3D_GLAPI PFNGLCREATETEXTURESPROC glCreateTextures;
O3D_GLAPI PFNGLTEXTUREBUFFERPROC glTextureBuffer;
O3D_GLAPI PFNGLTEXTUREBUFFERRANGEPROC glTextureBufferRange;
O3D_GLAPI PFNGLTEXTURESTORAGE1DPROC glTextureStorage1D;
O3D_GLAPI PFNGLTEXTURESTORAGE2DPROC glTextureStorage2D;
O3D_GLAPI PFNGLTEXTURESTORAGE3DPROC glTextureStorage3D;
O3D_GLAPI PFNGLTEXTURESTORAGE2DMULTISAMPLEPROC glTextureStorage2DMultisample;
O3D_GLAPI PFNGLTEXTURESTORAGE3DMULTISAMPLEPROC glTextureStorage3DMultisample;
O3D_GLAPI PFNGLTEXTURESUBIMAGE1DPROC glTextureSubImage1D;
O3D_GLAPI PFNGLTEXTURESUBIMAGE2DPROC glTextureSubImage2D;
O3D_GLAPI PFNGLTEXTURESUBIMAGE3DPROC glTextureSubImage3D;
O3D_GLAPI PFNGLCOMPRESSEDTEXTURESUBIMAGE1DPROC glCompressedTextureSubImage1D;
O3D_GLAPI PFNGLCOMPRESSEDTEXTURESUBIMAGE2DPROC glCompressedTextureSubImage2D;
O3D_GLAPI PFNGLCOMPRESSEDTEXTURESUBIMAGE3DPROC glCompressedTextureSubImage3D;
O3D_GLAPI PFNGLCOPYTEXTURESUBIMAGE1DPROC glCopyTextureSubImage1D;
O3D_GLAPI PFNGLCOPYTEXTURESUBIMAGE2DPROC glCopyTextureSubImage2D;
O3D_GLAPI PFNGLCOPYTEXTURESUBIMAGE3DPROC glCopyTextureSubImage3D;
O3D_GLAPI PFNGLTEXTUREPARAMETERFPROC glTextureParameterf;
O3D_GLAPI PFNGLTEXTUREPARAMETERFVPROC glTextureParameterfv;
O3D_GLAPI PFNGLTEXTUREPARAMETERIPROC glTextureParameteri;
O3D_GLAPI PFNGLTEXTUREPARAMETERIIVPROC glTextureParameterIiv;
O3D_GLAPI PFNGLTEXTUREPARAMETERIUIVPROC glTextureParameterIuiv;
O3D_GLAPI PFNGLTEXTUREPARAMETERIVPROC glTextureParameteriv;
O3D_GLAPI PFNGLGENERATETEXTUREMIPMAPPROC glGenerateTextureMipmap;
O3D_GLAPI PFNGLBINDTEXTUREUNITPROC glBindTextureUnit;
O3D_GLAPI PFNGLGETTEXTUREIMAGEPROC glGetTextureImage;
O3D_GLAPI PFNGLGETCOMPRESSEDTEXTUREIMAGEPROC glGetCompressedTextureImage;
O3D_GLAPI PFNGLGETTEXTURELEVELPARAMETERFVPROC glGetTextureLevelParameterfv;
O3D_GLAPI PFNGLGETTEXTURELEVELPARAMETERIVPROC glGetTextureLevelParameteriv;
O3D_GLAPI PFNGLGETTEXTUREPARAMETERFVPROC glGetTextureParameterfv;
O3D_GLAPI PFNGLGETTEXTUREPARAMETERIIVPROC glGetTextureParameterIiv;
O3D_GLAPI PFNGLGETTEXTUREPARAMETERIUIVPROC glGetTextureParameterIuiv;
O3D_GLAPI PFNGLGETTEXTUREPARAMETERIVPROC glGetTextureParameteriv;
O3D_GLAPI PFNGLCREATEVERTEXARRAYSPROC glCreateVertexArrays;
O3D_GLAPI PFNGLDISABLEVERTEXARRAYATTRIBPROC glDisableVertexArrayAttrib;
O3D_GLAPI PFNGLENABLEVERTEXARRAYATTRIBPROC glEnableVertexArrayAttrib;
O3D_GLAPI PFNGLVERTEXARRAYELEMENTBUFFERPROC glVertexArrayElementBuffer;
O3D_GLAPI PFNGLVERTEXARRAYVERTEXBUFFERPROC glVertexArrayVertexBuffer;
O3D_GLAPI PFNGLVERTEXARRAYVERTEXBUFFERSPROC glVertexArrayVertexBuffers;
O3D_GLAPI PFNGLVERTEXARRAYATTRIBBINDINGPROC glVertexArrayAttribBinding;
O3D_GLAPI PFNGLVERTEXARRAYATTRIBFORMATPROC glVertexArrayAttribFormat;
O3D_GLAPI PFNGLVERTEXARRAYATTRIBIFORMATPROC glVertexArrayAttribIFormat;
O3D_GLAPI PFNGLVERTEXARRAYATTRIBLFORMATPROC glVertexArrayAttribLFormat;
O3D_GLAPI PFNGLVERTEXARRAYBINDINGDIVISORPROC glVertexArrayBindingDivisor;
O3D_GLAPI PFNGLGETVERTEXARRAYIVPROC glGetVertexArrayiv;
O3D_GLAPI PFNGLGETVERTEXARRAYINDEXEDIVPROC glGetVertexArrayIndexediv;
O3D_GLAPI PFNGLGETVERTEXARRAYINDEXED64IVPROC glGetVertexArrayIndexed64iv;
O3D_GLAPI PFNGLCREATESAMPLERSPROC glCreateSamplers;
O3D_GLAPI PFNGLCREATEPROGRAMPIPELINESPROC glCreateProgramPipelines;
O3D_GLAPI PFNGLCREATEQUERIESPROC glCreateQueries;
O3D_GLAPI PFNGLGETQUERYBUFFEROBJECTI64VPROC glGetQueryBufferObjecti64v;
O3D_GLAPI PFNGLGETQUERYBUFFEROBJECTIVPROC glGetQueryBufferObjectiv;
O3D_GLAPI PFNGLGETQUERYBUFFEROBJECTUI64VPROC glGetQueryBufferObjectui64v;
O3D_GLAPI PFNGLGETQUERYBUFFEROBJECTUIVPROC glGetQueryBufferObjectuiv;
O3D_GLAPI PFNGLMEMORYBARRIERBYREGIONPROC glMemoryBarrierByRegion;
O3D_GLAPI PFNGLGETTEXTURESUBIMAGEPROC glGetTextureSubImage;
O3D_GLAPI PFNGLGETCOMPRESSEDTEXTURESUBIMAGEPROC glGetCompressedTextureSubImage;
O3D_GLAPI PFNGLGETGRAPHICSRESETSTATUSPROC glGetGraphicsResetStatus;
O3D_GLAPI PFNGLGETNCOMPRESSEDTEXIMAGEPROC glGetnCompressedTexImage;
O3D_GLAPI PFNGLGETNTEXIMAGEPROC glGetnTexImage;
O3D_GLAPI PFNGLGETNUNIFORMDVPROC glGetnUniformdv;
O3D_GLAPI PFNGLGETNUNIFORMFVPROC glGetnUniformfv;
O3D_GLAPI PFNGLGETNUNIFORMIVPROC glGetnUniformiv;
O3D_GLAPI PFNGLGETNUNIFORMUIVPROC glGetnUniformuiv;
O3D_GLAPI PFNGLREADNPIXELSPROC glReadnPixels;
O3D_GLAPI PFNGLGETNMAPDVPROC glGetnMapdv;
O3D_GLAPI PFNGLGETNMAPFVPROC glGetnMapfv;
O3D_GLAPI PFNGLGETNMAPIVPROC glGetnMapiv;
O3D_GLAPI PFNGLGETNPIXELMAPFVPROC glGetnPixelMapfv;
O3D_GLAPI PFNGLGETNPIXELMAPUIVPROC glGetnPixelMapuiv;
O3D_GLAPI PFNGLGETNPIXELMAPUSVPROC glGetnPixelMapusv;
O3D_GLAPI PFNGLGETNPOLYGONSTIPPLEPROC glGetnPolygonStipple;
O3D_GLAPI PFNGLGETNCOLORTABLEPROC glGetnColorTable;
O3D_GLAPI PFNGLGETNCONVOLUTIONFILTERPROC glGetnConvolutionFilter;
O3D_GLAPI PFNGLGETNSEPARABLEFILTERPROC glGetnSeparableFilter;
O3D_GLAPI PFNGLGETNHISTOGRAMPROC glGetnHistogram;
O3D_GLAPI PFNGLGETNMINMAXPROC glGetnMinmax;
O3D_GLAPI PFNGLTEXTUREBARRIERPROC glTextureBarrier;
