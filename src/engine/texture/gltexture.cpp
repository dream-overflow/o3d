...
struct Formats
{
	...
	TextureFormat formatGL2;
	TextureIntFormat intFormatGL2;
	UInt32 dataBitsPerPixel;
	UInt32 intBitsPerPixel;
	UInt32 intBitsPerPixelGL2;
};

static const Formats formatsMap[PF_RGBA_DXT5+1] = {
	{ PF_RED_U8,  DATA_UNSIGNED_BYTE, TF_RED, TIF_R8,   TF_LUMINANCE, TIF_LUMINANCE8, 8, 8, 4*8 },
	{ PF_RED_F16, DATA_HALF_FLOAT,    TF_RED, TIF_R16F, TF_LUMINANCE, TIF_LUMINANCE16F, 16, 16, 4*16 },
	{ PF_RED_F32, DATA_FLOAT,         TF_RED, TIF_R32F, TF_LUMINANCE, TIF_LUMINANCE32F, 32, 32, 4*32 },

	{ PF_RG_U8,  DATA_UNSIGNED_BYTE, TF_RG, TIF_RG8,   TF_LUMINANCE_ALPHA, TIF_LUMINANCE8_ALPHA8, 2*8, 2*8, 4*8 },
	{ PF_RG_F16, DATA_HALF_FLOAT,    TF_RG, TIF_RG16F, TF_LUMINANCE_ALPHA, TIF_LUMINANCE_ALPHA16F, 2*16, 2*16, 4*16 },
	{ PF_RG_F32, DATA_FLOAT,         TF_RG, TIF_RG32F, TF_LUMINANCE_ALPHA, TIF_LUMINANCE_ALPHA32F, 2*32, 2*32, 4*32 },

	{ PF_RGB_U8,  DATA_UNSIGNED_BYTE, TF_RGB, TIF_RGB8,   TF_RGB, TIF_RGB8, 3*8, 3*8, 4*8 },
	{ PF_RGB_F16, DATA_HALF_FLOAT,    TF_RGB, TIF_RGB16F, TF_RGB, TIF_RGB16F, 3*16, 3*16, 4*16 },
	{ PF_RGB_F32, DATA_FLOAT,         TF_RGB, TIF_RGB32F, TF_RGB, TIF_RGB32F, 3*32, 3*32, 4*32 },

	{ PF_RGBA_U8,  DATA_UNSIGNED_BYTE, TF_RGBA, TIF_RGBA8,   TF_RGBA, TIF_RGBA8, 4*8, 4*8, 4*8 },
	{ PF_RGBA_F16, DATA_HALF_FLOAT,    TF_RGBA, TIF_RGBA16F, TF_RGBA, TIF_RGBA16F, 4*16, 4*16, 4*16 },
	{ PF_RGBA_F32, DATA_FLOAT,         TF_RGBA, TIF_RGBA32F, TF_RGBA, TIF_RGBA32F, 4*32, 4*32, 4*32 },

	{ PF_DEPTH,     DATA_UNSIGNED_INT,   TF_DEPTH_COMPONENT, TIF_DEPTH_COMPONENT24,  TF_DEPTH_COMPONENT, TIF_DEPTH_COMPONENT24, 32, 24, 24 },
    { PF_DEPTH_U16, DATA_UNSIGNED_SHORT, TF_DEPTH_COMPONENT, TIF_DEPTH_COMPONENT16,  TF_DEPTH_COMPONENT, TIF_DEPTH_COMPONENT16, 16, 16, 16 },
    { PF_DEPTH_U24, DATA_UNSIGNED_INT,   TF_DEPTH_COMPONENT, TIF_DEPTH_COMPONENT24,  TF_DEPTH_COMPONENT, TIF_DEPTH_COMPONENT24, 32, 24, 24 },
    { PF_DEPTH_U32, DATA_UNSIGNED_INT,   TF_DEPTH_COMPONENT, TIF_DEPTH_COMPONENT32,  TF_DEPTH_COMPONENT, TIF_DEPTH_COMPONENT32, 32, 32, 32 },
	{ PF_DEPTH_F32, DATA_FLOAT,          TF_DEPTH_COMPONENT, TIF_DEPTH_COMPONENT32F, TF_DEPTH_COMPONENT, TIF_DEPTH_COMPONENT32F, 32, 32, 32 },
	{ PF_DEPTH_U24_STENCIL_U8, DATA_UNSIGNED_INT_24_8, TF_DEPTH_STENCIL, TIF_DEPTH24_STENCIL8, TF_DEPTH_STENCIL, TIF_DEPTH24_STENCIL8, 32, 32, 32 },
    { PF_DEPTH_F32_STENCIL_U8, DATA_FLOAT32_UNSIGNED_INT_24_8, TF_DEPTH_STENCIL, TIF_DEPTH32F_STENCIL8, TF_DEPTH_STENCIL, TIF_DEPTH32F_STENCIL8, 32, 32, 32 },

	{ PF_RGB_DXT1,  DATA_UNSIGNED_BYTE, TF_COMPRESSED_RGB_S3TC_DXT1,  TIF_COMPRESSED_RGB_S3TC_DXT1,  TF_COMPRESSED_RGB_S3TC_DXT1,  TIF_COMPRESSED_RGB_S3TC_DXT1,  4, 4, 4 },
	{ PF_RGBA_DXT1, DATA_UNSIGNED_BYTE, TF_COMPRESSED_RGBA_S3TC_DXT1, TIF_COMPRESSED_RGBA_S3TC_DXT1, TF_COMPRESSED_RGBA_S3TC_DXT1, TIF_COMPRESSED_RGBA_S3TC_DXT1, 4, 4, 4 },
	{ PF_RGBA_DXT3, DATA_UNSIGNED_BYTE, TF_COMPRESSED_RGBA_S3TC_DXT3, TIF_COMPRESSED_RGBA_S3TC_DXT3, TF_COMPRESSED_RGBA_S3TC_DXT3, TIF_COMPRESSED_RGBA_S3TC_DXT3, 8, 8, 8 },
	{ PF_RGBA_DXT5, DATA_UNSIGNED_BYTE, TF_COMPRESSED_RGBA_S3TC_DXT5, TIF_COMPRESSED_RGBA_S3TC_DXT5, TF_COMPRESSED_RGBA_S3TC_DXT5, TIF_COMPRESSED_RGBA_S3TC_DXT5, 8, 8, 8 }
